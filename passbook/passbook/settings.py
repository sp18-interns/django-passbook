...
SECRET_KEY = 'django-insecure-!s(4*0!*j9s@oiw=z#ogd(3wn#4mdp9g54n@r400@&)jg2(klh'
...
AUTH_USER_MODEL = 'api.UserCredentials'
...
DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql', 'NAME': 'passbook', 'USER': 'postgres',
                         'PASSWORD': '#Tingri051091', 'HOST': 'localhost', 'PORT': '5432'}}
